  ...
  <section class="settings-group">
    ...
    <details class="advanced" open={preset === 'Custom'}>
      ...
      <div class="advanced-body">
        ...
        <input aria-label="Maximum server RAM allocation" type="range" min="1024" max={Math.max(1024, profile.safeMaxMemoryMb)} step="256" bind:value={ramMb} oninput={markCustom} />
