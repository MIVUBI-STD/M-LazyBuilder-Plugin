...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::performance_diagnostics::performance_jfr_status,
            commands::performance_diagnostics::performance_jfr_start,
            commands::performance_diagnostics::performance_jfr_stop,
