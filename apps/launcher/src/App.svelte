  ...
  async function refreshWorkspaceState() {
    ...
    try {
      const [nextWorkspaceState, nextRuntimes] = await Promise.all([
        ...
        runtimeProduct.server.runtimes().catch(() => [])
      ]);
