<script lang="ts">
  ...
  export let report: StartupReport;
...
<section class="blocked-shell" aria-labelledby="blocked-heading">
  <div class="blocked-copy">
    ...
    <p>LazyBuilder stopped before enabling server-changing controls because one or more startup checks did not complete safely. Your registered server files are not modified by this screen.</p>
