...
$readme = @(
    ...
    '',
    'Server:',
    '  server/plugins/Telegram placeholder',
    '',
    'Use the JAR actually present under server/plugins as the Paper Terraform Manager plugin.',
    'Use the JAR under client/mods as the Fabric Terraform Manager client mod.',
    '',
    'Target runtime:',
