...
/** Duplicate flow keeps heavy copy server-owned while presenting one continuous operation. */
public final class DuplicateWorldScreen extends Screen {
    ...
    public DuplicateWorldScreen(Screen parent, ClientWorldController controller, WorldControlWireProtocol.WorldSummary source) {
