...
/**
 * Optional writable GPU growth optimization.
 *
 * This hook is intentionally separate from terrain residency/recovery ownership so compatibility
 * with ImmediatelyFast can disable only the overlapping resize optimization.
 */
@Mixin(VertexBuffer.class)
abstract class VertexBufferGrowthMixin {
